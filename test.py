...
def main(model_path, total_episodes=1000, plot: bool = True, **kwargs):
    ...
    ALGORITHMS = {
        ...
        "COMP": lambda x: power_alo_from_all_bs(
            x, n_users=kwargs["num_users"], n_base_stations=kwargs["num_base_stations"]
        ),
    }
    ...
    for model_file in model_path:
        ...
        ALGORITHMS[_modelname] = lambda x, model=model: model.predict(
